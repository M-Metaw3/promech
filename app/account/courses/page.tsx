...
//         } else {
//           const response = await fetch(`http://localhost:1337/api/bookings?populate[course][populate][imgSrc]=true&populate[course][populate][chapters][populate][lessons]=true&populate[user][populate]=true&filters[isBooking]=true&filters[user]=${parsetoken?.user?.id}`);
    ...
    const fetchData = async (): Promise<void> => {
      try {
        ...
        if (!tokenString) {
          ...
          const response = await fetch(`http://localhost:1337/api/bookings?populate[course][populate][imgSrc]=true&populate[course][populate][chapters][populate][lessons]=true&populate[user][populate]=true&filters[isBooking]=true&filters[user]=${parsetoken?.user?.id}&populate[course][populate][userimage]=true`);
          const datares = await response.json();
          setdata(datares);
        }
      } catch (error) {
