...
console.log(blog.attributes)
    ...
    return (
        ...
        >
            <Image
                src={blog&&blog?.attributes&&blog?.attributes?.thubnail&&blog?.attributes?.thubnail?.data&&blog?.attributes?.thubnail?.data?.attributes?.url?`http://localhost:1337${blog?.attributes?.thubnail?.data?.attributes?.url}`:''} alt={blog?.attributes?.title}
