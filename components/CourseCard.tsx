...
{}
            ...
            <Box position='relative' width='100%' height={266}>
                <Image
                    src={course?.attributes?.imgSrc?.data?.attributes.url?`http://promech-backend.addictaco.com${course?.attributes?.imgSrc?.data?.attributes.url}`:''} alt={course?.attributes?.title}
