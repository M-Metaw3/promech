...
// //         try {
// //           const response = await fetch('http://promech-backend.addictaco.com/api/tracks?fields[0]=title');
...
// //     //   console.log(`http://promech-backend.addictaco.com${dataapi?.mainImgSrc?.data?.attributes?.url}`)
